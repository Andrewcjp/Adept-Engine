...
{
	AllocDesc() {};
	AllocDesc(UINT size, D3D12_RESOURCE_STATES State = D3D12_RESOURCE_STATES::D3D12_RESOURCE_STATE_COMMON, std::string name = std::string(), EGPUMemorysegment::Type seg = EGPUMemorysegment::Local);
	UINT Size = 0;
	UINT Alignment = 0;
