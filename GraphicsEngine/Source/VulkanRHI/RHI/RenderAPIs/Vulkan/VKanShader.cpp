...
void VKanShader::SetupPSO()
{
	...
	if (vkCreatePipelineLayout(VKanRHI::GetVDefaultDevice()->device, &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS)
	{
	...
	if (vkCreateRenderPass(VKanRHI::GetVDefaultDevice()->device, &renderPassInfo, nullptr, &renderPass) != VK_SUCCESS)
	{
	...
	if (vkCreateGraphicsPipelines(VKanRHI::GetVDefaultDevice()->device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS)
	{
