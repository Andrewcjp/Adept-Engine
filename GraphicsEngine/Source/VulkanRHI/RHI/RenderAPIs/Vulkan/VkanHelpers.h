...
public:
	...
	static VkImageView createImageView(VkanDeviceContext * C, VkImage image, VkFormat format, VkImageAspectFlags aspectFlags = VK_IMAGE_ASPECT_COLOR_BIT, int layer = 1);
