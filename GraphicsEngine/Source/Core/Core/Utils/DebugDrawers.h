...
public:
	...
	static void DrawHalfCircle(const glm::vec3 & Base, const glm::vec3 & X, const glm::vec3 & Y,
	...
	static void DrawDebugCapsule(glm::vec3 const & Center, float HalfHeight, float Radius, glm::quat & Rotation,
		glm::vec3 const & Color = glm::vec3(1), bool bPersistentLines = false, float LifeTime = 0.01f, float Thickness = 1.0f);
